...
export const ADMIN_API_PERMISSION_MAP = {
  ...
  '/api/admin/call-settings/customer-profiles': [PERMISSIONS.settings.view, PERMISSIONS.settings.edit],
  '/api/admin/call-settings/customer-profiles/:id': [PERMISSIONS.settings.view, PERMISSIONS.settings.edit],
  '/api/admin/call-settings/scripts': [PERMISSIONS.settings.view, PERMISSIONS.settings.edit],
  '/api/admin/call-settings/scripts/:id': [PERMISSIONS.settings.view, PERMISSIONS.settings.edit],
  '/api/admin/demo-call/config': [PERMISSIONS.settings.view, PERMISSIONS.settings.edit],
  '/api/admin/demo-call/voices/:id': [PERMISSIONS.settings.view, PERMISSIONS.settings.edit],
  '/api/admin/demo-call/profile': [PERMISSIONS.settings.view, PERMISSIONS.settings.edit],
  '/api/admin/demo-call/script': [PERMISSIONS.settings.view, PERMISSIONS.settings.edit],
  '/api/admin/call-settings/plan-options': [PERMISSIONS.settings.view],
  '/api/admin/call-settings/plans': [PERMISSIONS.settings.view, PERMISSIONS.settings.edit],
  '/api/admin/call-settings/plans/:id': [PERMISSIONS.settings.view, PERMISSIONS.settings.edit],
  ...
  '/api/admin/analytics/holdings/:id': [PERMISSIONS.analytics.view],
  '/api/admin/analytics/dealerships': [PERMISSIONS.analytics.view],
  '/api/admin/analytics/dealerships/:id': [PERMISSIONS.analytics.view],
  '/api/admin/analytics/dealerships/:id/plans': [PERMISSIONS.analytics.view],
  '/api/admin/analytics/dealerships/:id/plans/:planId/exclude': [PERMISSIONS.analytics.view, PERMISSIONS.settings.edit],
  '/api/admin/analytics/managers': [PERMISSIONS.analytics.view],
  '/api/admin/analytics/managers/:id': [PERMISSIONS.analytics.view],
  '/api/admin/analytics/managers/:id/plans': [PERMISSIONS.analytics.view],
  '/api/admin/analytics/managers/:id/plans/:planId/exclude': [PERMISSIONS.analytics.view, PERMISSIONS.settings.edit],
