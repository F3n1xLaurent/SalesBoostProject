...
import type { CallInsightDetail } from '../../model/call-insight/types';
import { buildIndicators, clamp, formatDurationSec, getCallQualityTag, scoreToColor, type UiIndicator } from '../../lib/demo-report/utils';
